  ...
  try {
    ...
    return Function(
      ...
      utils: {
        ...
        parseQuery: import_fast_querystring.parseQuery,
        parseQueryFromURL: import_fast_querystring.parseQueryFromURL,
      ...
      error: {
        ...
        ParseError: import_error.ParseError
      },
      schema: app.router.history,
      // @ts-expect-error
      definitions: app.definitions.type,
      ERROR_CODE: import_error2.ERROR_CODE,
      parseCookie: import_cookies.parseCookie,
      ...
      ELYSIA_TRACE: import_trace.ELYSIA_TRACE,
      ELYSIA_REQUEST_ID: import_utils.ELYSIA_REQUEST_ID,
      // @ts-expect-error private property
      getServer: () => app.getServer(),
      TypeBoxError: import_typebox.TypeBoxError,
      parser: app["~parser"],
      ...adapter.inject
    });
  } catch (error2) {
