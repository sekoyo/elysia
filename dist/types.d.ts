...
export type InlineHandler<Route extends RouteSchema = {}, Singleton extends SingletonBase = {
    ...
    derive: {};
    resolve: {};
}, Path extends string | undefined = undefined, MacroContext = {}> = ((context: Context<Route, Singleton, Path>) => Response | MaybePromise<{} extends Route['response'] ? unknown : (Route['response'] extends {
    200: any;
...
type _ComposeElysiaResponse<Schema extends RouteSchema, Handle> = Prettify<{} extends Schema['response'] ? Prettify<{
    200: Exclude<Handle, ElysiaCustomStatusResponse<any, any, any>>;
} & ExtractErrorFromHandle<Handle> & (EmptyRouteSchema extends Schema ? {} : {
    422: {
        type: 'validation';
        on: string;
        summary?: string;
